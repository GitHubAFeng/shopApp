...
/**
 * Created by AFeng on 2018/5/11.
 */

public class GoodsTypeAdapter extends BaseQuickAdapter<ShopType, BaseViewHolder> {

    public GoodsTypeAdapter(int layoutResId, @Nullable List<ShopType> data) {
