...
* @Description: TODO(加密常用类)
* @author: 王东
* @date: 2015-9-11 上午10:40:49
*/
public class EncryptUtil {
	// 密钥是16位长度的byte[]进行Base64转换后得到的字符串
	public static String key = "bn5G3rRqW5Wh3uezbMtbB38u";

	/**
	* @Title: encrypt
	* @Description: TODO(加密)
	* @param: @param xmlStr 需要加密的字符串
	* @param: @return 加密后的值
	* @author: 王东
	* @date: 2015-9-11 上午10:41:05 
	*/
	...
	* @Title: decrypt
	* @Description: TODO(解密)
	* @param: @param xmlStr 解密的字符串
	* @param: @return 解密后的值
	* @author: 王东
	* @date: 2015-9-11 上午10:41:56 
	*/
