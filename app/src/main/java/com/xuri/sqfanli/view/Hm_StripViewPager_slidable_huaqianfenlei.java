...
/**
 * @Title: 花钱页面专用的组件
 * @Description:  内含viewpager和滑动切换标题颜色等功能
 * @author 何明洋
 */

public class Hm_StripViewPager_slidable_huaqianfenlei extends LinearLayout {
    public int width;
    public int height;
    public Callback_string callback_iv_all;
    Context context;
    ViewPager_ pager;
    String tabTitle[];
    ...
    public Hm_StripViewPager_slidable_huaqianfenlei(Context context) {
        super(context);
    ...
    public Hm_StripViewPager_slidable_huaqianfenlei(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        setOrientation(LinearLayout.VERTICAL);
        initView_prepare();
    ...
    void initView_prepare() {
        ...
        pager.setId(R.id.tv);//required a view id to avoid crash.
    ...
    public void initView(int parentWidth, int parentHeight) {
        removeAllViews();
...
//            tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, (float) (tv.getTextSize() * 0.8));
        ...
        LinearLayout layout_tab = new LinearLayout(context);
        layout_tab.setBackgroundColor(getResources().getColor(R.color.white));
        //“全部”图标
        ImageView iv_all = new ImageView(context);
//        iv_all.setPadding(40, 40, 40, 40);
        iv_all.setPadding(20, 20, 20, 20);
        iv_all.setBackgroundColor(Color.parseColor("#ffffff"));
        iv_all.setImageResource(R.drawable.huaqianfenleiquanbu);
        iv_all.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (callback_iv_all != null) {
                    callback_iv_all.call("");

                }
            }
        });

        layout_tab.addView(horizontalScrollView, screenWidth - tabHeight, ViewGroup.LayoutParams.WRAP_CONTENT);
        layout_tab.addView(iv_all, tabHeight, tabHeight);

        addView(layout_tab, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        添加pager
         */
        int pagerHeight = (int) (parentHeight - tabHeight - tabHeight * 0.05);
...
//                        horizontalScrollView.smoothScrollTo(xPos - screenWidth / 2, 0);
//                    }
//
//                }
