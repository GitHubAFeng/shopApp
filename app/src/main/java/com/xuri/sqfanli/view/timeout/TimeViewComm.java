...
public class TimeViewComm extends LinearLayout {
    ...
    public TimeViewComm(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setDrawable_sub = array.getDrawable(R.styleable.TimeViewComm_tvc_setDrawable_sub);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            if (setDrawable_sub == null){
                ...
                mHours.setBackground(setDrawable_sub);
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            if (setDrawable_sub == null){
                ...
                mMinutes.setBackground(setDrawable_sub);
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            if (setDrawable_sub == null){
                ...
                mSeconds.setBackground(setDrawable_sub);
            }
        }
